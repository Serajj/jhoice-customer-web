				...
				<div class="flex rounded-md sm:col-span-2" dir="ltr">
					...
					<button
						class="
							...
							hover:bg-gray-100
							focus:outline-none focus:ring-1 focus:ring-main-color-500 focus:border-main-color-500
						"
						type="button"
...
<div class="card" id ="first_card">
  <input type="radio" name="tab" value="igotnone" @click="show1(); toggleCardColor('first_card');" />
  As soon as possible
</div>
<br>
<div class="card" id ="second_card">
  <input type="radio" name="tab" value="igottwo" @click="show2(); toggleCardColor('second_card');" />
  Schedule an order
</div>
...
<div id="div2" class="div2 hide">
  ...
  <button class="rounded-button" @click="showDatePicker()">Select date</button>
...
<div id="date-picker" style="display: none;"></div>
	...
	<div class ="button-container">
		<button class ="rounded-button" @click="showTimePicker()">Select a time</button>
